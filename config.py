...
winWidth = 1200
winHeight = 660
# just duplicate of winwidth and winheight
wHe = winHeight
wWi = winWidth
...
vil = [
    Enemy(
        0, 520, 77, 64, 1200, 0), Enemy(
            400, 520, 77, 64, 1200, 0), Enemy(
                0, 40, 77, 64, 1200, 0), Enemy(
                    400, 40, 77, 64, 1200, 0), Enemy(
                        220, 160, 77, 64, 1200, 0), Enemy(
                            660, 160, 77, 64, 1200, 0), Enemy(
                                0, 280, 77, 64, 1200, 0), Enemy(
                                    950, 280, 77, 64, 1200, 0), Enemy(
                                        500, 400, 77, 64, 1200, 0)]
coins = [
    Coin(
        100, 130), Coin(
            400, 130), Coin(
